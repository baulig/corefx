...
namespace System
{
    public static partial class PlatformDetection
    {
        ...
        public static bool SupportsAlpn => (IsWindows && !IsWindows7 && !IsMono) ||
            ((!IsOSX && !IsWindows && !IsMono) &&
            (OpenSslVersion.Major >= 1 && (OpenSslVersion.Minor >= 1 || OpenSslVersion.Build >= 2)));
        public static bool SupportsClientAlpn => SupportsAlpn ||
            (!IsMono && RuntimeInformation.IsOSPlatform(OSPlatform.OSX) && PlatformDetection.OSXVersion > new Version(10, 12));
        public static bool SupportsSsl2AndSsl3 => !IsMono;
